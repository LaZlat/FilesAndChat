        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Msg = table.Column<string>(maxLength: 256, nullable: false),
                    UserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FriendFiles_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FriendFiles_Friends_FriendId",
                        column: x => x.FriendId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendFiles_FileId",
                table: "FriendFiles",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendFiles_FriendId",
                table: "FriendFiles",
                column: "FriendId");
